...
<head>
    ...
    <title>Connexion - ENSAT Students</title>
...
<body class="font-sans antialiased bg-gray-900">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-900">
        <div class="w-full sm:max-w-md mt-6 px-6 py-8 bg-gray-800 shadow-lg rounded-lg">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-400 mt-2">Connexion àvotre compte</p>
            </div>
            ...
            <form id="login-form" onsubmit="event.preventDefault(); handleLogin();" class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center">
                        <input type="checkbox" class="rounded bg-gray-700 border-gray-600 text-indigo-600 focus:ring-indigo-500">
    ...
    <script>
        function handleLogin() {
            ...
            loginWithEmail(email, password, button);
        }
    </script>
</body>
</html>
